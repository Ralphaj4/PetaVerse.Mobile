...
_PetDto _$PetDtoFromJson(Map<String, dynamic> json) => _PetDto(
  ...
  coatColorId: (json['coatColorId'] as num?)?.toInt(),
  coatColorName: json['coatColorName'] as String?,
...
Map<String, dynamic> _$PetDtoToJson(_PetDto instance) => <String, dynamic>{
  ...
  'coatColorId': instance.coatColorId,
  'coatColorName': instance.coatColorName,
