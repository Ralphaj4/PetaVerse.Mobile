...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,gender,dateOfBirth,breedId,breedName,speciesName,sizeId,sizeName,coatColorId,coatColorName,microchipNumber,microchipLocation,sterilizationStatus,sterilizationDate,createdAt,avatarUrl,isPrimaryOwner);
...
switch (_that) {
case _PetDto() when $default != null:
return $default(_that.id,_that.name,_that.gender,_that.dateOfBirth,_that.breedId,_that.breedName,_that.speciesName,_that.sizeId,_that.sizeName,_that.coatColorId,_that.coatColorName,_that.microchipNumber,_that.microchipLocation,_that.sterilizationStatus,_that.sterilizationDate,_that.createdAt,_that.avatarUrl,_that.isPrimaryOwner);case _:
  return orElse();
