    ...
    return SingleChildScrollView(
      ...
      child: FormBuilder(
        ...
        initialValue: {
          ...
          // Seed 0 ("Not specified") when the pet has no size/color yet.
          'sizeId': widget.pet.sizeId ?? 0,
          'coatColorId': widget.pet.coatColorId ?? 0,
          'microchipNumber': widget.pet.microchipNumber,
          'microchipLocation': widget.pet.microchipLocation,
          // Empty string is the "Not specified" sentinel; seed it when unset.
...
/// Optional size dropdown, backed by [petSizesListProvider]. Includes a leading
/// "Not specified" (sentinel 0) option so the FK can be cleared to null.
...
/// leading "Not specified" (sentinel 0) option so the FK can be cleared to null.
